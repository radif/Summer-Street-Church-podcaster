...
*/
    ...
    if (charPtr[i]=='\0') i++;
    ///Added by Nick Cipollo///
	if( (int)([data length]-i) < 0)
	{	
		NSLog(@"APIC frame is corrupt");
		return NULL;
	}
...
-(id3V2Frame *)getFirstFrameNamed:(NSString *)Name
{
    ...
    if ([value isKindOfClass:[NSMutableArray class]]) return [value objectAtIndex:0];	//NSARRAY?!?!?!
    else return value;
}
